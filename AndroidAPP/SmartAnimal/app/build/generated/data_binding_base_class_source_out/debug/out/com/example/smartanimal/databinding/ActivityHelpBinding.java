...
public final class ActivityHelpBinding implements ViewBinding {
  ...
  private ActivityHelpBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ActivityHelpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHelpBinding((ConstraintLayout) rootView, textView);
    }
